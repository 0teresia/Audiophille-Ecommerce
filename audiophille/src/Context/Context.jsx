        ...
        const list = [
            {
                ...
                inputs: [
                    {id: 1, label: "Name", input: "", placeholder: "John doe", isLarge: false},
                    {id: 2, label: "Email Address", input: "", placeholder: "youremail@gmail.com", isLarge: false},
                    {id: 3, label: "Phone Number", input: "", placeholder: "+254-712-345-678", isLarge: false},
                ]
            },
            {
                id: 2, 
                title: "Shipping Info", 
                inputs: [
                    {id: 4, label: "Your Address", input: "", placeholder: "000 Nairobi Kenya", isLarge: true}, 
                    {id: 5, label: "Zip Code", input: "", placeholder: "00100", isLarge: false},
                    {id: 6, label: "City", input: "", placeholder: "Nairobi", isLarge: false},
                    {id: 7, label: "Country", input: "", placeholder: "Kenya", isLarge: false},
                ]
            },
            {
                id: 3,
                ...
                isCash: false,
                inputs: [
                    {id: 8, label: "e-Money Number", placeholder: "12345678", isLarge: false},
                    {id: 9, label: "e-Money PIN", placeholder: "0000", isLarge: false},
                ]
            }
        ]
        setInputList(list)
    ...
    const toggleModal = (modalType) => {
        if(modalType === "cart") {
            if(modals.shop) {
                ...
                setModals(prevState => ({
                    ...prevState, cart: !prevState.cart, lightbox: !prevState.lightbox
                }));
            }
            ...
            if(modals.cart) {
                ...
                setModals(prevState => ({
                    ...prevState, shop: !prevState.shop, lightbox: !prevState.lightbox
                }));
            }
        } 
    };
