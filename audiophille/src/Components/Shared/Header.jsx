...
const Header = () => {
  ...
  return (
    <div className="h-[100px] xl:h-[97px] w-full bg-[#000] flex justify-center absolute top-0 z-50">
      <div className="w-[100%] md:w-[689px] xl:w-[1110px] border-b border-[white] border-opacity-10 flex items-center h-full justify-between relative">
        <img
          src={logoAudiophile}
          alt="audiophile logo"
          className={`mr-auto ${screenType === "desktop" ? "pl-[10px]" : ""}`}
        />
