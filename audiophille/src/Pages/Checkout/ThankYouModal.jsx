...
const ThankYouModal = () => {
  ...
  return (
    <div className="flex flex-col items-start w-[327px] md:w-[540px] min-h-[600px] md:min-h-[581px] bg-white fixed z-50 rounded-lg p-[32px] md:p-[48px] left-1/2 -translate-x-1/2 top-1/2 -translate-y-3/4">
        ...
        <h1 className="uppercase font-bold leading-[28px] md:leading-[36px] tracking-[0.857px] md:tracking-[1.143px] text-[24px] md:text-[32px] mt-[23px] md:mt-[33px]">Thank you for your order</h1>
        <p className="text-[15px] font-medium leading-[25px] opacity-50 mt-[16px] md:mt-[24px]">You will recieve an email confirmation shortly.</p>
